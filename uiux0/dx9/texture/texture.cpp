...
int WINAPI WinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPSTR lpCmdLine, _In_ int nCmdShow) {
    ...
    std::vector<VStruct> vertices{
        VStruct{ -1.0f, -1.0f, 1.0f, 0.0f, 1.0f, D3DXCOLOR{ 1.0f, 0.0f, 0.0f, 1.0f } },
        VStruct{ -1.0f,  1.0f, 1.0f, 0.0f, 0.0f, D3DXCOLOR{ 0.0f, 1.0f, 0.0f, 1.0f } },
        VStruct{  1.0f,  1.0f, 1.0f, 1.0f, 0.0f, D3DXCOLOR{ 0.0f, 0.0f, 1.0f, 1.0f } },
        VStruct{  1.0f, -1.0f, 1.0f, 1.0f, 1.0f, D3DXCOLOR{ 1.0f, 1.0f, 0.0f, 1.0f } }
    };
